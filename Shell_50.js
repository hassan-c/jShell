...
var text = {
    ...
    errors: {
        ...
        noFiles: '<b>Error:</b> No files have been created.',
...
// Aliases to make things shorter and reduce overhead of accessing DOM
// every time we want to access the console or output container.
var console = $('#console');
var output = $('#output');
